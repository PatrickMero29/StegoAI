...
class MessageEncoder:
    def __init__(self, latent_dim=512, ecc_symbols=32): 
...
if __name__ == "__main__":
    encoder = MessageEncoder(latent_dim=512, ecc_symbols=32)
    ...
    try:
        ...
        recovered_bits = encoder.latent_to_binary(latent_batch[0], ecc_bits)
