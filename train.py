...
def train_model(num_epochs=5):
    ...
    criterion = StegoLoss(lambda_msg=1.0) #we keep lambda_msg slightly lower so the Generator focuses on drawing numbers for image quality phasing
    ...
    for epoch in range(num_epochs):
        ...
        save_image(fake_images.data[:25], f"saved_images/epoch_{epoch+1}.png", nrow=5, normalize=True)
